                    ...
                    properties: {
                        ui: {
                            ...
                            properties: {
                                ...
                                journey: { type: Type.OBJECT, properties: { title: { type: Type.STRING }, education: { type: Type.STRING }, selfReflection: { type: Type.STRING }, achievements: { type: Type.STRING }, projects: { type: Type.STRING }, volunteer: { type: Type.STRING }, gallery: { type: Type.STRING }, captionPrompt: { type: Type.STRING } } },
                                ...
                                admin: { type: Type.OBJECT, properties: { edit: { type: Type.STRING }, save: { type: Type.STRING }, addItem: { type: Type.STRING }, removeItem: { type: Type.STRING }, upload: { type: Type.STRING }, change: { type: Type.STRING }, deleteItem: { type: Type.STRING }, uploadError: { type: Type.STRING }, deleteConfirm: { type: Type.STRING }, deleteError: { type: Type.STRING }, avatarUploadError: { type: Type.STRING }, imageTooLargeError: { type: Type.STRING }, imageReadError: { type: Type.STRING } } },
